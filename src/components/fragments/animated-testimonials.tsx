...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    // Generate consistent random rotate values once on mount
  ...
  return (
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased px-4 md:px-8 lg:px-12 pt-20 pb-10 font-poppins overflow-hidden">

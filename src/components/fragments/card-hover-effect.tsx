...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border border-transparent group-hover:border-blue-500 relative z-20",
        className
      )}
    >
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-5 text-zinc-700 tracking-wide leading-relaxed text-sm text-center",
        className
      )}
    >
      {children}
